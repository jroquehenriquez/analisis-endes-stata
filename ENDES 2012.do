...
merge 1:1 CASEID using RE212232.dta
drop _merge

merge 1:1 CASEID using RE516171.dta
drop _merge

*Asignamos un nombre a la base de datos fusionada (ENDES violencia 2012) y guardamos"
save "F:\PROYECTOS DE INVESTIGACIÓN\ENDES violencia\Artículo 2023\ENDES violencia 2012.dta"
...
drop if V013==0
*Incluimos solo la categoría "Mujer seleccionada y entrevistada" (se excluyeron 6148 "Mujer no seleccionada" y 33 "Mujer seleccionada, pero la privacidad no es posible")*
keep if V044==1
   *comprobamos si nuestros hallazgos son coherentes con lo reportado en la ENDES 2022*
   svy: proportion D101A (coincide)
   svy: proportion D105A
   display 0.909 + 8.706 + 20.130(coincide)
...
*Incluimos solo las mujeres perteneciente a las categorías "Casado" y "Viviendo juntos" (se excluyeron 4224 "Nunca casada", 80 "Viuda", 44 "Divorciada" y 1599 "No viven juntos")*
...
svy: glm Viole_F i.D113_D114, fam(bin) link(log) nolog eform
...
svy: glm D108 i.D113_D114, fam(bin) link(log) nolog eform
...
svy: glm Viole_Ps i.V501 i.V013 i.V106 i.V717 i.V218_cat i.D121 i.Edad_p i.V701 i.D113_D114 i.V190 i.V025 i.SREGION, fam(poisson) link(log) nolog eform

12. **GENERAMOS LA TABLA 7**
svy: glm Viole_F i.V501 i.V013 i.V106 i.V717 i.V218_cat i.D121 i.Edad_p i.V701 i.D113_D114 i.V190 i.V025 i.SREGION i.D102 i.D103A_recat i.Situ_amen, fam(poisson) link(log) nolog eform

13. **GENERAMOS LA TABLA 8**
svy: glm D108 i.V501 i.V013 i.V106 i.V717 i.V218_cat i.D121 i.Edad_p i.V701 i.D113_D114 i.V190 i.V025 i.SREGION i.D102 i.D103A_recat i.Situ_amen, fam(poisson) link(log) nolog eform
