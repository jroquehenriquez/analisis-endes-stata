...
*Asignamos un nombre a la base de datos fusionada (ENDES violencia 2022) y guardamos"
save "F:\PROYECTOS DE INVESTIGACIÓN\ENDES violencia\Artículo 2023\ENDES violencia 2022.dta"
...
4.**ESTABLECEMOS LA INFORMACIÓN MUESTRAL CON LA INSTRUCCIÓN svyset (NO SE CONSIDERO Strata, POR EL SIGUIENTE MENSAJE "Missing standard errors because of stratum with single sampling unit")**
svyset [pweight=Peso], psu(V001)
...
*Excluimos a las mujeres entre 12-14 años de edad (3506 observaciones eliminadas)*
drop if V013==0
*Incluimos solo la categoría "Mujer seleccionada y entrevistada" (se excluyeron 6846 "Mujer no seleccionada" y 37 "Mujer seleccionada, pero la privacidad no es posible")*
keep if V044==1
...
*Incluimos solo las mujeres perteneciente a las categorías "Casado" y "Viviendo juntos" (se excluyeron 4077 "Nunca casada", 52 "Viuda", 36 "Divorciada" y 3167 "No viven juntos")*
...
svy: proportion V013
svy: proportion V106
*todos salen como "no trabaja", por eso V717 no fue tomado en cuenta*
svy: proportion V717
...
svy: glm Viole_Ps i.V501 i.V013 i.V106 i.V218_cat i.D121 i.Edad_p i.V701 i.D113_D114 i.V190 i.V025 i.SREGION, fam(poisson) link(log) nolog eform

12. **GENERAMOS LA TABLA 7**
svy: glm Viole_F i.V501 i.V013 i.V106 i.V218_cat i.D121 i.Edad_p i.V701 i.D113_D114 i.V190 i.V025 i.SREGION i.D102 i.D103A_recat i.Situ_amen, fam(poisson) link(log) nolog eform

13. **GENERAMOS LA TABLA 8**
svy: glm D108 i.V501 i.V013 i.V106 i.V218_cat i.D121 i.Edad_p i.V701 i.D113_D114 i.V190 i.V025 i.SREGION i.D102 i.D103A_recat i.Situ_amen, fam(poisson) link(log) nolog eform
